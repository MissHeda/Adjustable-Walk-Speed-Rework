 ...
 * awsr_movement_fnc_rebuildAnimations drops the cache whenever a whitelist setting changes.
 *
 * Arguments:
 ...
 *
 * Example:
 * private _type = (animationState player) call awsr_movement_fnc_animationType;
 *
 * Public: No
 */
