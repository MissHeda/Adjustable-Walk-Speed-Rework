 ...
 *
 * awsr_movement_fnc_autorunStop registers this for a fraction of a second and takes it off again.
 ...
 *
 * Example:
 * player addEventHandler ["HandleDamage", {call awsr_movement_fnc_autorunStopDamage}];
 *
 * Public: No
 */
